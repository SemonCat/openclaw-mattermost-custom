...
openclaw plugins install \
  /tmp/openclaw/mattermost-custom/openclaw-mattermost-custom-2026.9.3.tgz --force
```
...
OpenClaw 2026.9.3 restart-recovery runs also reconnect channel/group session
...
(`2026.9.3`), not the OpenClaw monorepo checkout. One category of tests
